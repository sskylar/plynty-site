 ...
 * there are multiple material apps on the same page, each ngapp
 * will create its own instance of this array and the ngapp's IDs
 * will not be unique.
 */
var nextUniqueId = 0;
...
function attachToDocument( $mdGesture, $$MdGestureHandler ) {
  ...
  if (!isInitialized && $mdGesture.isHijackingClicks ) {
     ...
     *  - events that originate from an Ionic ngapp
     */
 ...
 *
 * ```js
 * ngapp.service('$mdToast', function($$interimElement) {
